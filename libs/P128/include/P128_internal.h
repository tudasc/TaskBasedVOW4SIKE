...
extern const uint64_t p128p1[NWORDS64_FIELD];
extern const uint64_t p128x2[NWORDS64_FIELD];
extern const uint64_t Montgomery_rprime1[NWORDS64_ORDER];
extern const uint64_t Montgomery_R2[NWORDS64_ORDER];
extern const uint64_t Montgomery_one[NWORDS64_ORDER];
